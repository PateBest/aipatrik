// Suora konfiguraatio - Sun Mar  9 22:56:34 UTC 2025
...
// Asetetaan kaikki mahdolliset konfiguraatiomuuttujat
window.CONFIG = window.DIRECT_CONFIG;
window.INLINE_CONFIG = window.DIRECT_CONFIG;
window.SUPABASE_CONFIG = window.DIRECT_CONFIG;
